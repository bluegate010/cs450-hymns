 ...
 */
public interface SpatialPointDatabase<E extends SpatialPoint> extends
		Collection<E> {
	/**
	...
	/**
	 * <p>
	 * Returns a list of the nearest neighbors to a given query point. The
	 * returned list is sorted by increasing distance from the query point.
	 * </p>
	 * 
	 * <p>
	 * This returned list will contain at most {@code maxResults} elements (and
	 * may contain fewer if {@code maxResults} is larger than the number of
	...
	/**
	 * <p>
	 * Returns a list of the nearest neighbors to a given query point and within
	 * a given maximum distance. The returned list is sorted by increasing
